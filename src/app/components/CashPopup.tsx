...
function CashHistoryButton({ onCashHistory }: { onCashHistory?: () => void }) {
  return (
    <div className="w-full flex justify-start">
      ...
      >
        <p className="font-['Pretendard:Medium',sans-serif] text-[12px] leading-[18px] text-[#b6b8b9] whitespace-nowrap">
          내 캐시 히스토리
        </p>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[32.653px] items-start relative shrink-0 w-full" data-name="container">
      ...
      <div className="content-stretch flex gap-[8.163px] items-center relative shrink-0 w-full" data-name="Buttom group">
        <button
          onClick={onClose}
          className="bg-[#9678ff] flex-[1_0_0] h-[44.898px] min-w-px relative rounded-[8.163px] cursor-pointer active:bg-[#654ec1] transition-colors"
        >
...
export default function CashPopup({
  ...
  return (
    <>
      ...
      {/* 팝업 */}
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#262626] content-stretch flex flex-col gap-[16px] items-center w-[min(350px,calc(100vw-32px))] overflow-clip p-[24px] rounded-[16px] z-50">
