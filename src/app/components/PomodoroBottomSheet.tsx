/**
 * PomodoroBottomSheet — 뽀모도로 모드 설정 바텀시트
 *
 * ## 개요
 * 타이머 설정 화면에서 뽀모도로 토글을 켰을 때 표시되는 바텀시트 컴포넌트.
 * 집중 시간과 휴식 시간을 분 단위로 설정할 수 있다.
 *
 * ## 주요 기능
 * - 집중 시간 선택: 5분~60분 범위의 옵션 드럼롤(스크롤 피커)
 * - 휴식 시간 선택: 1분~20분 범위의 옵션 드럼롤(스크롤 피커)
 * - 설정 완료 후 onConfirm(focusMin, breakMin) 콜백으로 부모에게 전달
 * - 취소 시 onCancel 콜백 호출
 */
